...
- CRITICAL: When creating a board, you MUST call create_board AND multiple create_card tools ALL in the same response. Never stop after just create_board. Create at least 5 cards spread across the columns. Never create an empty board.
